    ...
    <div className="my-10">
      <div className="text-center py-8 text-3xl">
        ...
        <p className="w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600">
          ...
          eligendi laboriosam aliquid fugiat ipsam, nesciunt laudantium
          voluptatem nemo dolor unde magnam dicta quisquam, quis voluptas,
          tempora deleniti doloremque ullam!
        </p>
      </div>
